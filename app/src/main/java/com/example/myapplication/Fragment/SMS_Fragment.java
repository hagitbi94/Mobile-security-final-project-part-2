...
import com.example.myapplication.Adapter.SMS_Adapter;
...
//        reference = FirebaseDatabase.getInstance().getReference("SMS/").child("/MQJFZkdDklQQoIAjTSZoAmP3IIy1" + "/");
//        reference = FirebaseDatabase.getInstance().getReference("SMS/");
